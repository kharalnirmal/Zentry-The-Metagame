...
}else
{
  ...
  return (
    <div
      ref={navContainerRef}
      className=" inset-x-0 fixed  top-4 z-50 h-16  border-none transition-all duration-700 sm:inset-x-6"
    >
      <header className=" absolute top-1/2   w-full  -translate-y-[50%] ">
